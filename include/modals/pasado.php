...
<!-- Modal Claim -->
<div class="modal fade px-0" id="modalBiografia" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="false" style="cursor: pointer; padding-left: 0px!important;">
    <div class="modal-dialog modal-dialog-centered justify-content-center" style="padding: 20px;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute; top: 0; right: 12px;">
            <span aria-hidden="true">&times;</span>
        </button>
        <img src="assets/img/biografia.png" class="img-fluid" alt="">
    </div>
</div>